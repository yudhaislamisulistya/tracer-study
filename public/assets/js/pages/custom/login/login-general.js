						...
						success: function (response) {
							if (response.status == 200) {
								Swal.fire({
									...
									text: "Selamat Data Anda Tersedia! Nama : "+nama+" Dengan NIM : "+nim+" Link Aktivasi Akan Dikirimkan Ke Email atau Whatsapp Anda",
									icon: 'warning',
									...
									if (result.isConfirmed) {
										$.ajax({
											...
											success: function (response) {
												...
												if (response.status == 200) {
													swal.fire({
														text: "Yuhuuuu!!! Kode Aktivasi Berhasil Dikirimkan Ke Email dan Whatsapp Anda.",
														icon: "success",
														buttonsStyling: false,
														confirmButtonText: "Ok!",
														customClass: {
