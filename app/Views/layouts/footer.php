                    ...
                    <div class=" container  d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="http://keenthemes.com/metronic" target="_blank"
                                class="text-dark-75 text-hover-primary">Crafted with love by IT Team Development</a>
                        </div>
                        <!--end::Copyright-->
                        ...
                        <div class="nav nav-dark order-1 order-md-2">
                            <a href="http://keenthemes.com/metronic" target="_blank"
                                class="nav-link pl-3 pr-0">Manual Book</a>
                        </div>
                        <!--end::Nav-->
                    </div>
                    <!--end::Container-->
                    ...
                    <div class="navi mt-2">
                        <a href="#" class="navi-item">
                            <span class="navi-link p-0 pb-2">
                                <span
                                    class="navi-text text-muted text-hover-primary"><?= get_data_registrasi(Session()->get('C_NPM'))->nomor_handphone ?></span>
                            </span>
                        </a>

                        <form action="<?= base_url() ?>/logout" method="POST">
                            <button class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign
                                Out</button>
                        </form>
                    </div>
                </div>
