...
<div class="d-flex flex-column-fluid mt-5">
    <div class="container">
        ...
        if (check_biodata(Session()->get('C_NPM')) != 0) { ?>
            ...
            <!--begin::Form-->
            <div class="card-body">
                <form class="form" id="kt_form" action="<?= base_url('kuesioner/store') ?>" method="POST">
                    <?= csrf_field() ?>
                        ...
                        <div class="card-body">
                            <div id="f5" class="form-group">
                                <div class="row">
                                    ...
                                    <label class="control-label col-sm-4">Berapa bulan waktu yang dihabiskan (sebelum dan sesudah kelulusan) untuk memeroleh pekerjaan pertama?</i></label>
                                    <div class="col-sm-7">
                                        <input name="f501" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f501)) == '1') {
                                                                echo "checked";
                                                            } ?> value="1" required type="radio">[1] Kira-kira <input name="f502" size="5" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f502; ?>" class="width40" type="text"> bulan sebelum lulus ujian &nbsp;&nbsp;<small>(f5-01, f5-02)</small><br /><br />
                                        <input name="f501" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f501)) == '2') {
                                                                echo "checked";
                                                            } ?> value="2" required type="radio">&nbsp;[2] Kira-kira <input class="width40" name="f503" size="5" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f503; ?>" type="text"> bulan setelah lulus ujian &nbsp;&nbsp;<small>(f5-01, f5-03)</small><br>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input value="1" name="f8" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f8)) == '1') {
                                                                        echo "checked";
                                                                    } ?> valuetable="" table-striped="" table-responsive="1" onclick="hide1()" type="radio"> [1] Ya <br>
                                        <input name="f8" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f8)) == '2') {
                                                                echo "checked";
                                                            } ?> value="2" onclick="show1()" type="radio"> [2] Tidak
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-striped table-responsive">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> Rp. &nbsp;
                                                        <input name="f1301" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f1301; ?>" size="20" type="text"><small>(f13-01)</small> (Isilah dengan ANGKA saja, tanpa tanda Titik atau Koma)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Dari Lembur dan Tips</td>
                                                    <td> Rp. &nbsp;
                                                        <input name="f1302" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f1302; ?>" size="20" type="text"><small>(f13-02)</small> (Isilah dengan ANGKA saja, tanpa tanda Titik atau Koma)</td>
                                                </tr>
                                                <tr>
                                                    <td>Dari Pekerjaan Lainnya</td>
                                                    <td> Rp. &nbsp;
                                                        <input name="f1303" value="<?= get_data_lulusan(Session()->get('C_NPM'))->f1303; ?>" size="20" type="text"><small>(f13-03)</small> (Isilah dengan ANGKA saja, tanpa tanda Titik atau Koma)</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-10">
                                                                <input name="f1101" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1101)) == '1') {
                                                                                        echo "checked";
                                                                                    } ?> value="1" type="radio"> [1] Instansi pemerintah (termasuk BUMN)<br>
                                                                ...
                                                                <input name="f1101" <?php if ((trim(get_data_lulusan(Session()->get('C_NPM'))->f1101)) == '5') {
                                                                                        echo "checked";
...
<script>
    var HOST_URL = "https://ts.umi.ac.id"
</script>
<script>
        ...
        $.ajax({
            ...
            success: function (response) {
                $.each(response.data, function (i, v) {
                    $('#kabupaten').append('<option value="' + v.name + '">' + v.name +
                        '</option>');
                });
            }
        });
