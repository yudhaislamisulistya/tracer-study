            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body text-center pt-4">
                        ...
                        <!--begin::Name-->
                        <div class="my-2">
                            <a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">YUDHA ISLAMI SULISTYA</a>
                        </div>
                        <!--end::Name-->

                        <!--begin::Label-->
                        <span
                            class="label label-inline label-lg label-light-warning btn-sm font-weight-bold">LULUSAN 2021</span>
                        <!--end::Label-->
                        ...
                        <div class="mt-9 mb-6">
                            ...
                            <a href="#" class="btn btn-md btn-icon btn-light btn-pill  mx-2">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-body text-center pt-4">
                        ...
                        <!--begin::Name-->
                        <div class="my-2">
                            <a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">KASMIRA</a>
                        </div>
                        <!--end::Name-->
