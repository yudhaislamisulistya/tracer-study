            ...
            <?php
                ...
                <?= csrf_field() ?>
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" class="form-control" name="tempat_lahir" placeholder="Tempat Lahir"
                                    id="tempat_lahir" value="<?= get_data_biodata(Session()->get('C_NPM'))->tempat_lahir ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="date" class="form-control" name="tanggal_lahir" placeholder="Tanggal Lahir"
                                    id="tanggal_lahir" value="<?= get_data_biodata(Session()->get('C_NPM'))->tanggal_lahir ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" class="form-control" name="nim" placeholder="NIM"
                                    id="nim" value="<?= get_data_registrasi(Session()->get('C_NPM'))->nim ?>" readonly/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                    ...
                                    <?php
                                        if (get_data_biodata(Session()->get('C_NPM'))->program_studi == '') {
                                            echo '<option value="">--Pilih Program Studi--</option>';
                                                ...
                                                echo '<option value="'.get_data_biodata(Session()->get('C_NPM'))->program_studi.'">'.get_data_biodata(Session()->get('C_NPM'))->program_studi.'</option>';
                                                echo '<option value="">--Pilih Program Studi--</option>';
                                            }
                                        ?>
                                    <?php
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" class="form-control" name="tahun_masuk" placeholder="Tahun Masuk"
                                    id="tahun_masuk" value="<?= get_data_biodata(Session()->get('C_NPM'))->tahun_masuk ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" class="form-control" name="tahun_keluar" placeholder="Tahun Keluar"
                                    id="tahun_keluar" value="<?= get_data_biodata(Session()->get('C_NPM'))->tahun_keluar ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                <input type="text" class="form-control" name="alamat" placeholder="Alamat Lengkap"
                                    id="alamat" value="<?= get_data_biodata(Session()->get('C_NPM'))->alamat ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                ...
                                <select name="negara" id="negara" class="form-control">
                                    <?php
                                        if (get_data_biodata(Session()->get('C_NPM'))->negara == '') {
                                            ...
                                            echo '<option value="'.get_data_biodata(Session()->get('C_NPM'))->negara.'">'.get_data_biodata(Session()->get('C_NPM'))->negara.'</option>';
                                            echo '<option value="">--Pilih Negara--</option>';
                                        }
                                    ?>
                                    <?php
                                ...
                                <select name="kabupaten" id="kabupaten" class="form-control">
                                    <?php
                                        if (get_data_biodata(Session()->get('C_NPM'))->kabupaten == '') {
                                            ...
                                            echo '<option value="'.get_data_biodata(Session()->get('C_NPM'))->kabupaten.'">'.get_data_biodata(Session()->get('C_NPM'))->kabupaten.'</option>';
                                            echo '<option value="">--Pilih Kabupaten--</option>';
                                        }
                                        ?>
                                    </select>
                    ...
                    <div class="form-group row">
                                ...
                                <select name="jenis_pekerjaan" id="jenis_pekerjaan" class="form-control">
                                    <?php
                                        if (get_data_biodata(Session()->get('C_NPM'))->jenis_pekerjaan == '') {
                                            ...
                                            echo '<option value="'.get_data_biodata(Session()->get('C_NPM'))->jenis_pekerjaan.'">'.get_data_biodata(Session()->get('C_NPM'))->jenis_pekerjaan.'</option>';
                                            echo '<option value="">--Pilih Jenis Pekerjaan--</option>';
                                        }
                                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                            <input type="text" class="form-control" name="nama_perusahaan" placeholder="Nama Kantor atau Perusahaan"
                                    id="nama_perusahaan" value="<?= get_data_biodata(Session()->get('C_NPM'))->nama_perusahaan ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                            <input type="date" class="form-control" name="tanggal_masuk_kerja" placeholder="Tanggal Masuk Kerja"
                                    id="tanggal_masuk_kerja" value="<?= get_data_biodata(Session()->get('C_NPM'))->tanggal_masuk_kerja ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" class="form-control" name="nomor_handphone" placeholder="Whatsapp"
                                    id="nomor_handphone" value="<?= get_data_registrasi(Session()->get('C_NPM'))->nomor_handphone ?>"/>
                                <div class="input-group-append">
                                    <span class="input-group-text">
        ...
        $.ajax({
            ...
            success: function (response) {
                $.each(response.data, function (i, v) { 
                    $('#kabupaten').append('<option value="'+v.name+'">'+v.name+'</option>');
                });
            }
        });
    });
